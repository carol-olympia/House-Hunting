                    ...
                    <tr>
                        <td class="container-fluid" id="formContainer">
                            <form id="loginForm" method="post">
                                <h3 class="form-signin-heading" style="color: #12aa1f; font-size: 1.7em">Log In</h3>
                                ...
                                <div class="d-grid">
                                    <button class="btn btn-block btn-purple" id="loginButton" style="margin-top:1em;background-color:#12aa1f;color:white;" type="submit">TAKE ME IN <img src="assets/img/right-arrow.png" alt="Right Arrow"></button>
                                </div>
                            </form>
                        </td>
                    </tr>
