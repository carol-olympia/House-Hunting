                    ...
                    <tr>
                        <td class="container-fluid">
                            ...
                            <form action="process_form.php" id="register_form" method="post" accept-charset="utf-8">
                                ...
                                <div class="d-grid">
                                    <button type="submit" id="registerButton" class="btn btn-block btn-purple" style="margin-top:2em; background-color:#12aa1f;color:white">Get Started Now <img src="assets/img/right-arrow.png" alt="Right Arrow"></button>
                                </div>
                            </form>
                        </td>
                    </tr>
